...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.200.115/24 | 192.168.200.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_BL2 | Vlan4094 | 10.255.252.15 | Port-Channel5 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | MLAG_PEER_DC1-BL2B_Ethernet5 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 5 |
| Ethernet6 | MLAG_PEER_DC1-BL2B_Ethernet6 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet8 | routed | - | 172.31.255.57/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet8 | routed | - | 172.31.255.59/31 | default | 1500 | false | - | - |
| Ethernet3 | P2P_LINK_TO_DC1-SPINE3_Ethernet8 | routed | - | 172.31.255.61/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_DC1-SPINE4_Ethernet8 | routed | - | 172.31.255.63/31 | default | 1500 | false | - | - |
...
!
interface Ethernet5
   description MLAG_PEER_DC1-BL2B_Ethernet5
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description MLAG_PEER_DC1-BL2B_Ethernet6
   no shutdown
   channel-group 5 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel5 | MLAG_PEER_DC1-BL2B_Po5 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel5
   description MLAG_PEER_DC1-BL2B_Po5
   no shutdown
   switchport
...
| Vlan3013 |  Tenant_A_WAN_Zone  |  10.255.251.14/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3020 |  Tenant_B_WAN_Zone  |  10.255.251.14/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3030 |  Tenant_C_WAN_Zone  |  10.255.251.14/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.251.14/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- |
| 10.255.251.15 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default |
| 172.31.255.56 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.31.255.58 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.31.255.60 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.31.255.62 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 192.168.255.1 | 65001 | default |
| 192.168.255.2 | 65001 | default |
| 192.168.255.3 | 65001 | default |
| 192.168.255.4 | 65001 | default |
| 10.255.251.15 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A_WAN_Zone |
| 10.255.251.15 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_B_WAN_Zone |
| 10.255.251.15 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_C_WAN_Zone |
...
router bgp 65105
   ...
   neighbor 10.255.251.15 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.251.15 description DC1-BL2B
   neighbor 172.31.255.56 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.56 description DC1-SPINE1_Ethernet8
   neighbor 172.31.255.58 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.58 description DC1-SPINE2_Ethernet8
   neighbor 172.31.255.60 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.60 description DC1-SPINE3_Ethernet8
   neighbor 172.31.255.62 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.62 description DC1-SPINE4_Ethernet8
