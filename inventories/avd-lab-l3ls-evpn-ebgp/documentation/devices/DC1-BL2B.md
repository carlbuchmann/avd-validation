...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.200.116/24 | 192.168.200.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_BL2 | Vlan4094 | 10.255.252.14 | Port-Channel5 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | MLAG_PEER_DC1-BL2A_Ethernet5 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 5 |
| Ethernet6 | MLAG_PEER_DC1-BL2A_Ethernet6 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet9 | routed | - | 172.31.255.65/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet9 | routed | - | 172.31.255.67/31 | default | 1500 | false | - | - |
| Ethernet3 | P2P_LINK_TO_DC1-SPINE3_Ethernet9 | routed | - | 172.31.255.69/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_DC1-SPINE4_Ethernet9 | routed | - | 172.31.255.71/31 | default | 1500 | false | - | - |
...
!
interface Ethernet5
   description MLAG_PEER_DC1-BL2A_Ethernet5
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description MLAG_PEER_DC1-BL2A_Ethernet6
   no shutdown
   channel-group 5 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel5 | MLAG_PEER_DC1-BL2A_Po5 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel5
   description MLAG_PEER_DC1-BL2A_Po5
   no shutdown
   switchport
...
| Vlan3013 |  Tenant_A_WAN_Zone  |  10.255.251.15/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3020 |  Tenant_B_WAN_Zone  |  10.255.251.15/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3030 |  Tenant_C_WAN_Zone  |  10.255.251.15/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.251.15/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- |
| 10.255.251.14 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default |
| 172.31.255.64 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.31.255.66 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.31.255.68 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.31.255.70 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 192.168.255.1 | 65001 | default |
| 192.168.255.2 | 65001 | default |
| 192.168.255.3 | 65001 | default |
| 192.168.255.4 | 65001 | default |
| 10.255.251.14 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A_WAN_Zone |
| 10.255.251.14 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_B_WAN_Zone |
| 10.255.251.14 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_C_WAN_Zone |
...
router bgp 65105
   ...
   neighbor 10.255.251.14 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.251.14 description DC1-BL2A
   neighbor 172.31.255.64 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.64 description DC1-SPINE1_Ethernet9
   neighbor 172.31.255.66 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.66 description DC1-SPINE2_Ethernet9
   neighbor 172.31.255.68 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.68 description DC1-SPINE3_Ethernet9
   neighbor 172.31.255.70 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.70 description DC1-SPINE4_Ethernet9
