...
mlag configuration
   ...
   peer-address heartbeat 192.168.200.115 vrf MGMT
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 |  P2P_LINK_TO_DC1-SPINE1_Ethernet9  |  routed  | - |  172.31.255.65/31  |  default  |  1500  |  -  |  -  |  -  |
| Ethernet2 |  P2P_LINK_TO_DC1-SPINE2_Ethernet9  |  routed  | - |  172.31.255.67/31  |  default  |  1500  |  -  |  -  |  -  |
| Ethernet3 |  P2P_LINK_TO_DC1-SPINE3_Ethernet9  |  routed  | - |  172.31.255.69/31  |  default  |  1500  |  -  |  -  |  -  |
| Ethernet4 |  P2P_LINK_TO_DC1-SPINE4_Ethernet9  |  routed  | - |  172.31.255.71/31  |  default  |  1500  |  -  |  -  |  -  |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel5 | MLAG_PEER_DC1-BL2A_Po5 | switched | access | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| Neighbor | Remote AS |
| -------- | ---------
| 10.255.251.14 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.31.255.64 | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.31.255.66 | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.31.255.68 | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.31.255.70 | Inherited from peer group IPv4-UNDERLAY-PEERS |
